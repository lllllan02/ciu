...
void run_all_tests() {
    printf("test_heap_sort_basic\n");
    test_heap_sort_basic();
    printf("test_heap_sort_already_sorted\n");
    test_heap_sort_already_sorted();
    printf("test_heap_sort_reverse_sorted\n");
    test_heap_sort_reverse_sorted();
    printf("test_heap_sort_duplicates\n");
    test_heap_sort_duplicates();
    printf("test_heap_sort_edge_cases\n");
...
void test_heap_sort_already_sorted() {
    int arr[] = {1, 2, 3, 4, 5};
...
void test_heap_sort_reverse_sorted() {
    int arr[] = {5, 4, 3, 2, 1};
...
void test_heap_sort_edge_cases() {
    int empty[] = {42};
    heap_sort(empty, 0);
    assert(empty[0] == 42);
