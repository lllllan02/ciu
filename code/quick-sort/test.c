...
void run_all_tests() {
    printf("test_quick_sort_basic\n");
    test_quick_sort_basic();
    printf("test_quick_sort_already_sorted\n");
    test_quick_sort_already_sorted();
    printf("test_quick_sort_reverse_sorted\n");
    test_quick_sort_reverse_sorted();
    printf("test_quick_sort_duplicates\n");
    test_quick_sort_duplicates();
    printf("test_quick_sort_edge_cases\n");
...
void test_quick_sort_edge_cases() {
    int empty[] = {42};
    quick_sort(empty, 0);
    assert(empty[0] == 42);
