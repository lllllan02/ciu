...
void run_all_tests() {
    printf("test_bubble_sort_basic\n");
    test_bubble_sort_basic();
    printf("test_bubble_sort_already_sorted\n");
    test_bubble_sort_already_sorted();
    printf("test_bubble_sort_reverse_sorted\n");
    test_bubble_sort_reverse_sorted();
    printf("test_bubble_sort_duplicates\n");
    test_bubble_sort_duplicates();
    printf("test_bubble_sort_edge_cases\n");
    test_bubble_sort_edge_cases();
}
...
void test_bubble_sort_edge_cases() {
    int empty[] = {42};
    bubble_sort(empty, 0);
    assert(empty[0] == 42);
